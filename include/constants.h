...
// Timing & Thresholds
#define CLOCK_OFFLINE_TIMEOUT_MS                                               \
  1000 // Stop flashing/BPM display if clock stops for 1s
#define BPM_FILTER_SIZE                                                        \
  24 // Average timing clocks (24 clocks = 1 quarter note at 24 PPQN)
#define ACTIVE_SENSING_TIMEOUT_MS                                              \
  1000 // Flag as disconnected if no active sensing within 1s

// Compilation modes
// Set to 1 to enable virtual MIDI generation for testing UI without hardware
// connected.
